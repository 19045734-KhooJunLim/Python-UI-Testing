...
class secondPage_lost(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        l1=Label(self, text="second",font=("Arial bold",30))
        l1.place(x=230, y=230)
        bHome=Button(self, text="Home",font=("Arial",15), command=lambda:controller.show_frame(firstPage))
        bHome.place(x=650, y=450)
